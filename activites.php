...
$prix = isset($_POST['prix']) ? intval($_POST['prix']) : 1000;
$duree = isset($_POST['duree']) ? intval($_POST['duree']) : 240;
$tri = ($_POST['tri'] ?? 'asc') === 'desc' ? 'desc' : 'asc';
$order_sql = "ORDER BY a.prixA " . strtoupper($tri);

$where = [
    "i.cheminImgA LIKE '%apercu%'",
    "a.prixA <= $prix",
    "a.dureeA <= $duree",
    "a.villeA = '$ville'"
];
